...
def _setup_weak_form(
    fes, epsilon_r, phys, V_c, L_c, homotopy_charge, homotopy_sigma, geom, msh, Feenstra, assume_full_ionization
):
...
def main():
    ...
    all_params = {
        ...
        "simulation": {"V_tip": args.V_tip, "model": args.model, "assume_full_ionization": args.assume_full_ionization},
        "args": vars(args),
    }
